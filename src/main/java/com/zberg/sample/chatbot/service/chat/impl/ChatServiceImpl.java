...
public class ChatServiceImpl implements ChatService {
    ...
    public ChatServiceImpl(final Environment env) {
    ...
    private Response sendMessageInternal(String text, String sessionId, String language) throws IOException {
        ...
        try (SessionsClient sessionsClient = SessionsClient.create(sessionSettings)) {
            ...
            final Response chatResponse = ResponseMapper.toResponse(response);
